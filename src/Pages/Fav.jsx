    ...
    return (
        <div>
            <ToastContainer
                ...
                theme='colored' />
                {
                    documents.filter((document) => document.favorite === true).length > 0 ?
                        <Grid container spacing={2}>
                        {    documents.filter((document) => document.favorite === true).map((document) => (
                        ...
                        : <div className='text-center w-100 d-flex justify-content-center align-items-center'><h3>Nothing here. Add some magic! ✨</h3></div>
                }
        </div>
    )
}
